//ejemplo: _result = [distanceSPWN,0,posHQ,veryBad] call A3A_fnc_distanceUnits: devuelve un array con todas las que estén a menos de distanceSPWN
//ejemplo: _result = [distanceSPWN,1,posHQ,good] call A3A_fnc_distanceUnits: devuelve un boolean si hay una que esté a menos de distanceSPWN
