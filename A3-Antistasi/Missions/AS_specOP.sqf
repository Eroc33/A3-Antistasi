...
waitUntil  {sleep 5; (dateToNumber date > _fechalimnum) or (sides getVariable [_marcador,sideUnknown] == good)};
...
if (dateToNumber date > _fechalimnum) then
	...
	if (_lado == bad) then {[3,0] remoteExec ["A3A_fnc_prestige",2]} else {[0,3] remoteExec ["A3A_fnc_prestige",2]};
