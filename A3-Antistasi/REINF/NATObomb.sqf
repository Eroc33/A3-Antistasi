...
if ({sides getVariable [_x,sideUnknown] == good} count airports == 0) exitWith {hint "You need to control an airport in order to fulfill this request"};
...
_planefn = [_origpos, _ang, vehSDKPlane, good] call bis_fnc_spawnvehicle;
